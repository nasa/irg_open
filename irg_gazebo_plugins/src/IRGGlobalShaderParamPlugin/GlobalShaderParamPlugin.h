...
namespace gazebo {
  ...
  class GlobalShaderParamPlugin : public VisualPlugin
  {
  public: 
  ...
  private:
    ...
    event::ConnectionPtr m_preRenderConnection;
    event::ConnectionPtr m_entityAddedConnection;
    event::ConnectionPtr m_entityDeletedConnection;
    event::ConnectionPtr m_worldCreatedConnection;
