...
{
PanTilt::PanTilt() : rqt_gui_cpp::Plugin(), m_widget(0) {
...
static void setDefaultTooltip(double defaultVal, QPushButton* button) {
  QString tt;
  tt.sprintf("Press to set default value (%.2f).\nTo change default value, hold button for at least 3 seconds",
             defaultVal);
  button->setToolTip(tt);
}

void PanTilt::restoreSettings(const qt_gui_cpp::Settings& /*plugin_settings*/,
