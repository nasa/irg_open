...
{
ImageTrigger::ImageTrigger() : rqt_gui_cpp::Plugin(), m_widget(0) {
...
void ImageTrigger::saveSettings(qt_gui_cpp::Settings& /*plugin_settings*/,
                                qt_gui_cpp::Settings& /*instance_settings*/) const {
}

void ImageTrigger::restoreSettings(const qt_gui_cpp::Settings& /*plugin_settings*/,
